...
> **Last updated:** 2026-03-25 | **Status:** IN PROGRESS (S1 ✅, S2 ✅, S3 ✅)
...
| ------------------------- | ----------------- | ---------------------------------------------------------- |
| `movieInfoProvider`       | `MovieInfo`       | Loads full movie detail on demand                          |
| `movieVideosProvider`     | `MovieVideos`     | Loads videos per movie ID                                  |
| `similarMoviesProvider`   | `SimilarMovies`   | Loads similar movies per movie ID                          |
